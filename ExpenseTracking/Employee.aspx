<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Employee.aspx.cs" Inherits="ExpenseTracking.Employee" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div id="tabs" style="overflow:auto;">
       ...
       <ul>
           ...
           <li><a href="#tabs-2">View Expense History</a></li>
       </ul>
       <div id="tabs-1">
       ...
       <div id="tabs-2">
          <div style="padding:10px;">
              <div>
                   <p><b>History of expenses submitted:</b></p>
               </div>
              <div>
                   <div class="floatLeft" style="padding-bottom:20px;">
                      <asp:Table ID="ExpenseTable" runat="server" BorderStyle="Solid" GridLines="Both" BorderWidth="1">
                          <asp:TableHeaderRow>
                              <asp:TableHeaderCell Width="20px">ID</asp:TableHeaderCell>
                              <asp:TableHeaderCell Width="100px">Description</asp:TableHeaderCell>
